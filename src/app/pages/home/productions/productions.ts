...
@Component({
  ...
  template: ` <section id="featured" class="bg-stone-900 p-5 m-4 shadow-lg">
    ...
    <p class="text-center text-2xl font-medium italic">Nenhum vídeo em destaque encontrado</p>
    }
  </section>`,
})
export class Productions {
  featuredProjects = computed(() => {
    return siteData.projects.videos.filter((project) => project.featured === true);
  });
